...
namespace VehicleMonitoring.EventBusRabbitMQ
{
    public class RabbitMQBus : IEventBus, IDisposable
    {
        private readonly string BROKER_NAME = "VehicleMonitoring.VehicleStatus.Exchange";
        private readonly string AUTOFAC_SCOPE_NAME = "Alten_event_bus";
